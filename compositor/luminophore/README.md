...
The monitor-board runtime and Shell use the [version 2 spatial contract](SPATIAL_PROTOCOL.md). The matching Shell is required; the legacy state endpoint no longer supplies editable snapshots.
