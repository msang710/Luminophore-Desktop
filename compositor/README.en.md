...
### Spatial desktop only

Numbered/named workspace navigation, previous/back-and-forth history, workspace swipe and workspace relocation dispatchers have been removed. Use Luminophore board/view actions. Internal per-monitor base desktops and the Spotify service container remain; they are not user workspaces. Existing removed commands and selectors are rejected.
