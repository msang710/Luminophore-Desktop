...
#include "../state/WindowPlacementController.hpp"
...
namespace Desktop::View {
    ...
    enum eWindowInputBlockReason : uint8_t {
        ...
        INPUT_BLOCK_SPATIAL_OUTSIDE_VIEW = (1 << 3),
    ...
    class CWindow : public virtual IView, public virtual CGeometricMovableAnimated, public virtual IAlphaModifiable {
      ...
      public:
        ...
        // Independent from m_hidden, which remains owned by monocle and swallow.
        bool                                            m_minimized = false;
        std::optional<Desktop::SWindowRestorePlacement> m_restorePlacement;
        ...
        bool                   isHidden() const;
        void                   setSpatiallySuppressed(bool suppressed);
        bool                   isSpatiallySuppressed() const;
        bool                   isMinimized() const;
        bool                   isDesktopSuppressed() const;
      ...
      private:
        ...
        bool                                                                             m_hidden              = false;
        bool                                                                             m_spatiallySuppressed = false;
