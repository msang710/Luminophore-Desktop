...
enum eWorkspaceRole : uint8_t {
    WORKSPACE_ROLE_UNKNOWN = 0,
    WORKSPACE_ROLE_BASE,
...
class CWorkspace {
  public:
    ...
    static eWorkspaceRole roleFor(std::string_view name, bool special);
    eWorkspaceRole        role() const;
    std::string_view      roleName() const;
    bool                  isBaseDesktop() const;
    bool                  isUserWorkspace() const;
