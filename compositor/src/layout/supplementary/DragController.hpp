...
#include "../../luminophore/LuminophoreDragIntentController.hpp"
...
namespace Layout::Supplementary {
    ...
    class CDragStateController {
      public:
        ...
        void           dragEnd(bool cancelled = false);
      ...
      private:
        ...
        Luminophore::CLuminophoreDragIntentController    m_dragIntentController;
    };
};
