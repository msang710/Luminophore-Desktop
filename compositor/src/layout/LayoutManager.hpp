...
namespace Layout {
    ...
    enum eDirectionalMoveResult : uint8_t {
    ...
    class CLayoutManager {
      public:
        ...
        void                    endDragTarget();
        void                    cancelDragTarget();

        void                    switchTargets(SP<ITarget> a, SP<ITarget> b, bool preserveFocus = true);

        eDirectionalMoveResult  moveInDirection(SP<ITarget> target, const std::string& direction, bool silent = false);
