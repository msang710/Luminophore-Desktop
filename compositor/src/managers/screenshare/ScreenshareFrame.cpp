...
#ifdef LUMINOPHORE_EFFECTS
    if (g_pHyprRenderer->m_luminophoreWindowEffect)
        g_pHyprRenderer->m_luminophoreWindowEffect->enqueueCapture(PWINDOW, PMONITOR, m_bufferSize);
#endif
