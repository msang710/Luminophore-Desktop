...
namespace Render {
    ...
    class IHyprRenderer {
      public:
        ...
        UP<CLuminophoreWindowEffect> m_luminophoreWindowEffect;
#endif
        ...
        SP<ITexture> blurMainFramebuffer(float a, CRegion* originalDamage, const std::optional<SBlurParameters>& parameters = std::nullopt);
        virtual SP<ITexture> blurFramebuffer(SP<IFramebuffer> source, float a, CRegion* originalDamage, const std::optional<SBlurParameters>& parameters = std::nullopt) = 0;
      ...
      protected:
        ...
        void renderLayer(PHLLS, PHLMONITOR, const Time::steady_tp&, bool popups = false, bool lockscreen = false, const Vector2D& offset = {}, float opacity = 1.F);
        void renderLuminophoreShellPlane(PHLMONITOR, const Time::steady_tp&);
