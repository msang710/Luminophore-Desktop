    ...
    class CHyprOpenGLImpl {
      public:
        ...
        struct SRectRenderData {
            ...
            float                          blurA         = 1.F;
            bool                           xray          = false;
            std::optional<SBlurParameters> blurParameters;
        };
      ...
      private:
        ...
        SP<IFramebuffer> blurFramebufferWithDamage(float a, CRegion* damage, CGLFramebuffer& source, const std::optional<SBlurParameters>& parameters = std::nullopt);
