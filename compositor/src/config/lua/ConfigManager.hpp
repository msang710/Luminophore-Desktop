...
namespace Config::Lua {
    ...
    class CConfigManager : public Config::IConfigManager {
      public:
        ...
        void                                     setValueExplicit(const std::string& name, bool explicitValue);
        void                                     setDeviceSettings(const Luminophore::Settings::DeviceSettings&) override;
        Luminophore::Settings::DeviceSettings    deviceSettings() const override;
